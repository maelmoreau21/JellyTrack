...
import { Film, Trophy, BarChart3, Layers } from "lucide-react";
...
export function MediaHeaderNav() {
    ...
    const tabs = [
        ...
        ...(isAdmin ? [{ href: '/media/analysis', label: t('deepAnalysisTitle'), icon: BarChart3, isActive: (p: string) => p.startsWith('/media/analysis') }] : []),
