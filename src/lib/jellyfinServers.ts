...
const JELLYTRACK_CLIENT_HEADER =
  'MediaBrowser Client="JellyTrack", Device="Server", DeviceId="JellyTrack-1", Version="2.0.1"';
...
export function buildJellyfinApiKeyHeaders(apiKey: string): HeadersInit {
  ...
  return {
    ...
    Authorization: `MediaBrowser Client="JellyTrack", Device="Server", DeviceId="JellyTrack-1", Version="2.0.1", Token="${token}"`,
  };
}
